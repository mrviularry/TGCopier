...
# allowed FX symbols
SYMBOLS = ['AUDCADp', 'AUDCHFp', 'AUDJPYp', 'AUDNZDp', 'AUDUSDp', 'CADCHFp', 'CADJPYp', 'CHFJPYp', 'EURAUDp', 'EURCADp', 'EURCHFp', 'EURGBP', 'EURJPYp', 'EURNZDp', 'EURUSDp', 'GBPAUDp', 'GBPCADp', 'GBPCHFp', 'GBPJPYp', 'GBPNZD', 'GBPUSDp', 'NOW', 'NZDCADp', 'NZDCHFp', 'NZDJPYp', 'NZDUSDp', 'USDCADp', 'USDCHFp', 'USDJPYp', 'XAGUSD', 'XAUUSDp']
